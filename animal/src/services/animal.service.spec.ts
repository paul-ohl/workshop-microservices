...
describe('AnimalService', () => {
        ...
        AnimalService,
        {
          ...
          useValue: {
            ...
            create: jest.fn().mockImplementation((dto) => ({
              ...
              save: jest
                .fn()
                .mockResolvedValue({ _id: '67471ad537e245d36b41c140', ...dto }),
            })),
          },
        },
        {
  ...
  describe('createAnimal', () => {
    it('should create an animal successfully', async () => {
      const dto = {
        name: 'Tiger',
        age: 3,
        categoryId: '674719cb37e245d36b41c13a',
        gender: 1,
      };
    ...
    it('should throw an error if category is not found', async () => {
      ...
      await expect(service.createAnimal(dto)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('getAnimalById', () => {
    ...
    it('should throw an error if animal is not found', async () => {
      ...
      await expect(service.getAnimalById(id)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
