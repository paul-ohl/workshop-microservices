...
describe('AnimalController', () => {
    ...
    describe('createCategory', () => {
        it('should call service.createCategory and return the result', async () => {
            ...
            const result = { _id: 'cat123', name: 'Mammals' } as Partial<Document> as any;
            ...
            expect(service.createCategory).toHaveBeenCalledWith(createCategoryDto.name);
        });
    });
    ...
    describe('getAllAnimals', () => {
        it('should call service.getAllAnimals and return the result', async () => {
            const result = [
                { _id: 'animal123', name: 'Tiger', age: 5, categoryId: 'cat123', gender: 1 },
            ] as Partial<Document> as any;
    ...
    describe('deleteAnimal', () => {
        it('should call service.deleteAnimal and return the result', async () => {
            const id = 'animal123';
            const result = { message: 'Animal deleted successfully' } as Partial<Document> as any;
